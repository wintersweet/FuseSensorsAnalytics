...
- (NSDictionary *)properties {
    ...
    NSString *latitude =   [NSString stringWithFormat:@"%.7f",self.coordinate.latitude];
    NSString *longitude =   [NSString stringWithFormat:@"%.7f",self.coordinate.longitude];
//    return @{kSAEventPresetPropertyLatitude: @(latitude), kSAEventPresetPropertyLongitude: @(longitude), kSAEventPresetPropertyCoordinateSystem: kSAAppleCoordinateSystem};
    return @{kSAEventPresetPropertyLatitude: latitude, kSAEventPresetPropertyLongitude: longitude};
}
