...
NSString * const kSAEventPropertyNotificationTitle = @"pushMsgTitle";
NSString * const kSAEventPropertyNotificationContent = @"pushMsgContent";
NSString * const kSAEventPropertyNotificationServiceName = @"pushMsgServiceName";
NSString * const kSAEventPropertyNotificationChannel = @"pushMsgChannel";
...
NSString * const kSAEventPropertyNotificationServiceNameFirebase = @"Firebase";
