...
#pragma mark - device
/// 设备 ID
NSString * const kSAEventPresetPropertyDeviceId = @"deviceId";
/// 运营商
static NSString * const SAEventPresetPropertyCarrier = @"netWorkCarrier";
/// 型号
static NSString * const SAEventPresetPropertyModel = @"deviceModel";
/// 生产商
static NSString * const SAEventPresetPropertyManufacturer = @"netWorkCarrier";
/// 屏幕高
static NSString * const SAEventPresetPropertyScreenHeight = @"screenHeight";
/// 屏幕宽
static NSString * const SAEventPresetPropertyScreenWidth = @"screenWidth";

#pragma mark - os
/// 系统
static NSString * const SAEventPresetPropertyOS = @"operatingSystem";
/// 系统版本
static NSString * const SAEventPresetPropertyOSVersion = @"osVersion";

#pragma mark - app
/// 应用版本
NSString * const kSAEventPresetPropertyAppVersion = @"appVersion";
/// 应用 ID
static NSString * const SAEventPresetPropertyAppID = @"appId";
/// 应用名称
static NSString * const SAEventPresetPropertyAppName = @"accessSystem";
/// 时区偏移量
static NSString * const SAEventPresetPropertyTimezoneOffset = @"timeZone";
/// 应用来源
NSString * const kSAEventPresetPropertyAppSource = @"appSource";
/// 手机品牌
NSString * const kSAEventPresetPropertyDeviceBrand = @"deviceBrand";
/// 应用名称
NSString * const kSAEventPresetPropertyAccessSystem = @"accessSystem";

NSString * const kSAEventPresetPropertyAppLanguage = @"appLanguage";


#pragma mark - state
/// 网络类型
NSString * const kSAEventPresetPropertyNetworkType = @"netWorkType";
/// 是否 WI-FI
NSString * const kSAEventPresetPropertyWifi = @"wifi";
/// 是否首日
NSString * const kSAEventPresetPropertyIsFirstDay = @"isFirstDay";

#pragma mark - lib
/// SDK 类型
NSString * const kSAEventPresetPropertyLib = @"lib";
/// SDK 方法
NSString * const kSAEventPresetPropertyLibMethod = @"libMethod";
/// SDK 版本
NSString * const kSAEventPresetPropertyLibVersion = @"libVersion";
/// SDK 版本
NSString * const kSAEventPresetPropertyLibDetail = @"libDetail";
...
//            _automaticProperties[kSAEventPresetPropertyLibVersion] = self.libVersion;
            ...
            NSArray  *GzoneArray = [[NSString stringWithFormat:@"%@", tempTZ] componentsSeparatedByString:@")"];
            NSString *GMTStr = GzoneArray.firstObject;

            _automaticProperties[SAEventPresetPropertyTimezoneOffset] = GMTStr;
            _automaticProperties[kSAEventPresetPropertyAppSource] = @"Apple Store";
            _automaticProperties[kSAEventPresetPropertyDeviceBrand] = @"Apple";
            _automaticProperties[kSAEventPresetPropertyAccessSystem] = @"FUSE PRO ID";
            
            NSUserDefaults *def = [NSUserDefaults standardUserDefaults];
            NSString *string = [def valueForKey:@"userLanguage"];
            _automaticProperties[kSAEventPresetPropertyAppLanguage] = string;
