...
extern NSString * const kSAEeventPropertyReferrerEventId;
extern NSString * const kSAEeventPropertyReferrerPageId;

extern NSString * const kSAEeventPropertyCurrentPageId;
extern NSString * const kSAEeventPropertyCurrentPageName;
