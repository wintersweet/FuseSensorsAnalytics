...
NSString * const kSAEventName = @"eventName";
NSString * const kSAEventDistinctId = @"distinctId";
NSString * const kSAEventProperties = @"where";
...
NSString * const kSAEventLoginId = @"loginId";
NSString * const kSAEventAnonymousId = @"anonymousId";
...
// App 浏览页面
NSString * const kSAEventNameAppViewScreen = @"AppViewPage";
// App 元素点击
...
// App 浏览页面 Url
NSString * const kSAEventPropertyScreenUrl = @"referrerPageName";
// App 浏览页面的Referrer Url
NSString * const kSAEventPropertyScreenReferrerUrl = @"referrer";
NSString * const kSAEventPropertyElementId = @"elementId";
NSString * const kSAEventPropertyScreenName = @"screenName";
NSString * const kSAEventPropertyTitle = @"title";
NSString * const kSAEventPropertyElementPosition = @"elementPosition";
NSString * const kSAEventPropertyElementSelector = @"elementSlector";

NSString * const kSAEeventPropertyReferrerTitle = @"referrerTitle";

NSString * const kSAEeventPropertyReferrerEventId = @"referrerEventId";
NSString * const kSAEeventPropertyReferrerPageId = @"referrerPageId";

NSString * const kSAEeventPropertyCurrentPageId = @"currentPageId";
NSString * const kSAEeventPropertyCurrentPageName = @"currentPageName";

// 模糊路径
NSString * const kSAEventPropertyElementPath = @"elementPath";
NSString * const kSAEventPropertyElementContent = @"elementContent";
NSString * const kSAEventPropertyElementType = @"elementType";
// 远程控制配置信息
NSString * const kSAEventPropertyAppRemoteConfig = @"appRemoteConfig";
...
NSSet* sensorsdata_reserved_properties() {
    return [NSSet setWithObjects:@"date", @"datetime", @"distinctId", @"event", @"events", @"firstId", @"id", @"originalId", @"properties", @"secondId", @"time", @"users", nil];
}
...
NSString * const kSAPageLeaveAutoTrackProperties = @"where";
NSString * const kSAEventDurationProperty = @"eventDuration";
